define([
    ...
    class Spreadsheet extends Component {
        ...
        renderColumnHeaderWithMenu(columnDef, columnNumber) {
            ...
            const menu = (() => {
                ...
                return [{
                    ...
                    action: () => {
                        this.doSortColumn(columnDef, columnNumber, true);
                    }
                }, {
                    title: 'Sort Descending',
                    action: () => {
                        this.doSortColumn(columnDef, columnNumber, false);
                    }
                }, {
                    title: 'Filter...',
                    action: () => {
            ...
            return this.props.columns.map((columnDef, columnNumber) => {
                ...
                return html`
                    <div className=${classes.join(' ')} 
                         ...
                         role="cell"
                         data-k-b-testhook-cell=${columnDef.key}>
                        ${this.renderColumnHeaderWithMenu(columnDef, columnNumber)}
                    </div>
               `;
            });
        }

        doSortColumn(columnDef, columnNumber, ascending) {
