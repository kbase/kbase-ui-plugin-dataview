define([
    ...
    class Overview extends Component {
        ...
        async fetchOutgoingReferences(wsClient, ref) {
            const [[result, ...rest]] = await wsClient.callFunc('get_object_provenance', [[{ref}]]);
            const objectRefs = result.provenance.reduce((objects, reference) => {
