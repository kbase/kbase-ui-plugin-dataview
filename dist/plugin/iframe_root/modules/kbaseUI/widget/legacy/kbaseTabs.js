...
return this.data("tabs")[t]},showTab:function(t){if(this.shouldShowTab(t)){
this.data("nav")[t].find("a").trigger("click")}},removeTab:function(t){
var a=this.data("tabs")[t],e=this.data("nav")[t]
