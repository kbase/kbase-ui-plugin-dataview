...
},u=function(e,i,r,n,o){return t.proxy((function(s,a){var u
;if(("keypress"!==s.type||13===s.which)&&(s.preventDefault(),
s.stopPropagation(),
(u="checked"===o.getter?!!this.is(":checked"):this[o.getter]())!==this.data("kbase_bindingValue"))){
if(void 0!==n.validator){var h=n.validator(u)
;if(!h.success)return t(e).data("validationError.kbaseBinding",h.msg),
...
;t(e).popover("hide"),h.newVal&&(u=h.newVal)}
void 0!==n.reverseTransformedValue&&(u=n.reverseTransformedValue(u))
;var p=i.__attributes[r].setter
;i[p](u),this.data("kbase_bindingValue",this[o.getter]())}}),t(e))
...
;var c=t(this).prop("tagName").toLowerCase()
;return c.match(/^(input)$/)&&(t(this).off("keypress.kbaseBinding",makeBindingEnterCallback(this,e,i,n,h)),
"checkbox"===t(this).attr("type")&&t(this).off("change.kbaseBinding",u(this,e,i,n,h))),
this};var p={}
...
h)t.isFunction(h[c])?s.prototype[c]=function(t,e){var i=function(){
throw"No parent method defined! Play by the rules!"},r=function(){
throw"No parent method defined! Play by the rules!"};if(n)i=function(){
...
;return function(){var t=this._super,n=this._superMethod
...
o){t.fn[i]=function(e,r){if(this.length>1){var n=arguments
;return t.each(this,(function(e,r){t.fn[i].apply(t(r),n)})),this}
...
;if("object"==typeof e||!e){r=arguments;var o=this.data(i)
;return void 0===o._init&&(o=s.prototype.init.apply(o,arguments)),
o._init=!0,o.trigger("initialized"),o}
...
name:"kbaseWidget",dbg:function(t){window.console&&console.log(t)},
...
return this.options.template&&t.ajax(this.options.template).done(t.proxy((function(t){
this.templateSuccess.apply(this,arguments)}),this)).fail(t.proxy((function(t){
this.templateFailure.apply(this,arguments)}),this)),e},
templateSuccess:function(i){
var r=e.compile(i),n=(r(),r(this.templateContent())),o=t.jqElem("span").append(n)
;this._rewireIds(o,this),this.$elem.append(o)},templateFailure:function(t){
...
e.removeAttr("id")),t.each(e.find("[id]"),(function(e){
