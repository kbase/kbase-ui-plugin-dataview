...
;return Object.freeze({request:function(t,o,n,s,i){var a={params:s,
...
timeout:i.timeout,data:JSON.stringify(a),header:c}).then((function(r){try{
return JSON.parse(r).result}catch(t){
throw new e.ResponseValueError(o,n,s,r,"Error processing response as json",t.message)
}})).catch(e.ClientError,e.ServerError,(function(r){var i,a,c;try{
...
;switch(i.error&&i.error.error&&"string"==typeof i.error.error&&(a=i.error.error.split("\n")).length>=2&&(c=a[a.length-2]),
c){case"AttributeError":throw new e.AttributeError(o,n,i);default:
