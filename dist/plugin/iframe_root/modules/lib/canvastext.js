define([],(function(){"use strict";var t={letters:{" ":{width:16,points:[]},
"!":{width:10,points:[[5,21],[5,7],[-1,-1],[5,2],[4,1],[5,0],[6,1],[5,2]]},'"':{
width:16,points:[[4,21],[4,14],[-1,-1],[12,21],[12,14]]},"#":{width:21,
...
width:26,points:[[13,18],[13,0],[-1,-1],[4,9],[22,9]]},",":{width:10,
points:[[5,14],[4,13],[5,12],[6,13],[5,14],[-1,-1],[6,1],[5,0],[4,1],[5,2],[6,1],[6,-1],[5,-3],[4,-4]]
},"-":{width:26,points:[[4,9],[22,9]]},".":{width:10,
points:[[5,2],[4,1],[5,0],[6,1],[5,2]]},"/":{width:22,points:[[20,25],[2,-7]]},
0:{width:20,
points:[[9,21],[6,20],[4,17],[3,12],[3,9],[4,4],[6,1],[9,0],[11,0],[14,1],[16,4],[17,9],[17,12],[16,17],[14,20],[11,21],[9,21]]
},1:{width:20,points:[[6,17],[8,18],[11,21],[11,0]]},2:{width:20,
...
},4:{width:20,points:[[13,21],[3,7],[18,7],[-1,-1],[13,21],[13,0]]},5:{width:20,
...
},7:{width:20,points:[[17,21],[7,0],[-1,-1],[3,21],[17,21]]},8:{width:20,
...
},"<":{width:24,points:[[20,18],[4,9],[20,0]]},"=":{width:26,
points:[[4,12],[22,12],[-1,-1],[4,6],[22,6]]},">":{width:24,
points:[[4,18],[20,9],[4,0]]},"?":{width:18,
...
points:[[4,21],[4,0],[-1,-1],[4,21],[17,21],[-1,-1],[4,11],[12,11]]},G:{
width:21,
points:[[18,16],[17,18],[15,20],[13,21],[9,21],[7,20],[5,18],[4,16],[3,13],[3,8],[4,5],[5,3],[7,1],[9,0],[13,0],[15,1],[17,3],[18,5],[18,8],[-1,-1],[13,8],[18,8]]
},H:{width:22,
points:[[4,21],[4,0],[-1,-1],[18,21],[18,0],[-1,-1],[4,11],[18,11]]},I:{width:8,
points:[[4,21],[4,0]]},J:{width:16,
points:[[12,21],[12,5],[11,2],[10,1],[8,0],[6,0],[4,1],[3,2],[2,5],[2,7]]},K:{
width:21,points:[[4,21],[4,0],[-1,-1],[18,21],[4,7],[-1,-1],[9,12],[18,0]]},L:{
width:17,points:[[4,21],[4,0],[-1,-1],[4,0],[16,0]]},M:{width:24,
...
l:{width:8,points:[[4,21],[4,0]]},m:{width:30,
...
v:{width:16,points:[[2,14],[8,0],[-1,-1],[14,14],[8,0]]},w:{width:22,
points:[[3,14],[7,0],[-1,-1],[11,14],[7,0],[-1,-1],[11,14],[15,0],[-1,-1],[19,14],[15,0]]
},x:{width:17,points:[[3,14],[14,0],[-1,-1],[14,14],[3,0]]},y:{width:16,
points:[[2,14],[8,0],[-1,-1],[14,14],[8,0],[6,-4],[4,-6],[2,-7],[1,-7]]},z:{
width:17,points:[[14,14],[3,0],[-1,-1],[3,14],[14,14],[-1,-1],[3,0],[14,0]]},
"{":{width:14,
...
},"|":{width:8,points:[[4,25],[4,-7]]},"}":{width:14,
...
}},letter:function(i){return t.letters[i]},ascent:function(t,i){return i},
descent:function(t,i){return 7*i/25},measure:function(i,n,o){
var s,d=0,h=o.length;for(s=0;s<h;s++){var w=t.letter(o.charAt(s))
;w&&(d+=w.width*n/25)}return d},draw:function(i,n,o,s,d,h){
var w,p=h.length,e=o/25
;for(i.save(),i.lineCap="round",i.lineWidth=2*e,w=0;w<p;w++){
var r=t.letter(h.charAt(w));if(r){i.beginPath();var u,a=1
;for(u=0;u<r.points.length;u+=1){var c=r.points[u]
;-1!==c[0]||-1!==c[1]?a?(i.moveTo(s+c[0]*e,d-c[1]*e),
a=!1):i.lineTo(s+c[0]*e,d-c[1]*e):a=1}i.stroke(),s+=r.width*e}}
return i.restore(),0},enable:function(i){i.drawText=function(n,o,s,d,h){
return t.draw(i,n,o,s,d,h)},i.measureText=function(i,n,o){
return t.measure(i,n,o)},i.fontAscent=function(i,n){return t.ascent(i,n)
},i.fontDescent=function(i,n){return t.descent(i,n)
},i.drawTextRight=function(n,o,s,d,h){var w=t.measure(n,o,h)
;return t.draw(i,n,o,s-w,d,h)},i.drawTextCenter=function(n,o,s,d,h){
var w=t.measure(n,o,h);return t.draw(i,n,o,s-w/2,d,h)}}};return t}));